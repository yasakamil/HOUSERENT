                ...
                <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="featured-thumb hover-zoomer mb-4">
                                    ...
                                    <div class="overlay-black overflow-hidden position-relative"> <img src="admin/property/<?php echo $row['18'];?>" alt="pimage">
                                        ...
                                        <a class="sale bg-success text-white" href="https://api.whatsapp.com/send?phone=6281291620809">For <?php echo $row['5'];?> | contact here</a>
                    ...
                    <div class="col-lg-4">
                        <div class="sidebar-widget">
                            <h4 class="double-down-line-left text-secondary position-relative pb-4 my-4">Instalment </h4>
